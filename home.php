    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <div class="attendance-button">
                <button id="startButton" class="add" onclick="if(typeof handleStartButtonClick === 'function') { handleStartButtonClick(); } else if(typeof window.handleStartButtonClick === 'function') { window.handleStartButtonClick(); } else { console.error('handleStartButtonClick not defined'); alert('Face recognition script not loaded. Please refresh the page.'); }">Launch Facial Recognition</button>
                <button id="endButton" class="add" style="display:none">End Attendance Process</button>
                <button id="endAttendance" class="add" onclick="if(typeof window.handleEndAttendance === 'function') { window.handleEndAttendance(); } else if(typeof handleEndAttendance === 'function') { handleEndAttendance(); } else { console.error('handleEndAttendance not defined'); alert('Please refresh the page.'); }">END Attendance Taking</button>
            </div>
